class MovieData{
  ...
  static List<MovieData> getMovies() => [
  ...
  MovieData(
    this.title, this.year, this.rated, this.released, this.runtime, this.genre, this.director, this.writer, this.actor, 
    this.plot, this.language, this.country, this.award, this.poster, this.metadata, this.imbdRating, this.imbdVotes, 
    this.imbdID, this.type, this.response, this.images
  );
}